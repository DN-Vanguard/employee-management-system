// MySQL Queries
// Due to using back ticks, I am not able to comment as much as I want.
// The queries are composed in this js and is able to pinpoint what the user is search for.
